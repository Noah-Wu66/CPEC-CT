...
function hasDisplayableModelProgress(message) {
  ...
  return Array.isArray(message.thinkingTimeline) && message.thinkingTimeline.length > 0;
}
...
export function mergeConversationMessages(serverMessages, localMessages) {
  ...
  return trailingLocalMessages.length > 0 ? [...merged, ...trailingLocalMessages] : merged;
}
