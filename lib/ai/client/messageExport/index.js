import { getBrandAssets } from "@/lib/ai/client/messageExport/assets";
import {
  buildFileName,
  downloadBlob,
  formatExportTime,
  normalizeExportText,
} from "@/lib/ai/client/messageExport/file";

const BRAND_TITLE = "智创 AI 工作台";
...
function buildDocxImageParagraph() {
  return [
    ...
    '<wp:docPr id="1" name="AI Studio Icon"/>',
...
async function buildDocxBlob(blocks, exportedAt) {
  ...
  const zipBytes = makeZip([
    ...
    },
    {
      ...
      data: '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>智创 AI 工作台</Application></Properties>',
    },
    {
      name: "docProps/core.xml",
      data: `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:title>${escapeXml(BRAND_TITLE)}</dc:title><dc:creator>智创 AI 工作台</dc:creator><cp:lastModifiedBy>智创 AI 工作台</cp:lastModifiedBy><dcterms:created xsi:type="dcterms:W3CDTF">${created}</dcterms:created><dcterms:modified xsi:type="dcterms:W3CDTF">${created}</dcterms:modified></cp:coreProperties>`,
    },
    {
