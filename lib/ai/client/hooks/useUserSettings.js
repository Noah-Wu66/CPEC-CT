...
import {
  ...
  UI_THEME_MODE_KEY,
  UI_WEB_SEARCH_KEY,
} from "@/lib/ai/shared/storageKeys";
import {
...
import {
  ...
  writeLocalJson,
  writeLocalSetting,
} from "@/lib/ai/client/localSettings";
import { DEFAULT_WEB_SEARCH_SETTINGS, normalizeWebSearchSettings } from "@/lib/ai/shared/webSearch";
...
export function useUserSettings() {
  ...
  const fetchSettings = useCallback(async () => {
    try {
      const data = await apiJson("/api/ai/settings");
