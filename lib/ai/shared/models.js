...
// 默认使用模型支持的最优推理强度
export const DEFAULT_MINIMAX_THINKING_LEVEL = "high";

export const CHAT_RUNTIME_MODE_CHAT = "chat";
export const DEFAULT_CHAT_RUNTIME_MODE = CHAT_RUNTIME_MODE_CHAT;

export const MINIMAX_REASONING_LEVELS = ["low", "medium", "high"];
export const MINIMAX_REASONING_LABELS = {
  low: "低",
  medium: "中",
  high: "高",
};
...
export function getDefaultMaxTokensForModel(modelId) {
  ...
  if (normalized === MINIMAX_M3_MODEL) {
    // MiniMax M3 支持较大输出，默认取高以获得最佳完整度。
    return 128000;
  }
  return 64000;
}
